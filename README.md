This is a Full-Stack Mobile App for Adopting Pets - You can see pet listings, add pets to favourites and adopt pets. It contains a user JWT factory, custom Message Handler and Trust Provider. 
