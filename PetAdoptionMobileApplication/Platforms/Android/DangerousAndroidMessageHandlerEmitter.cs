...
namespace PetAdoptionMobileApplication.Platforms.Android
{
    // to dynamically inherit from AndroidMessageHandler and override its internal GetSSLHostnameVerifier method, to return a dummy IHostNameVerifier:
